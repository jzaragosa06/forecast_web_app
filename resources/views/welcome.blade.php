...
<div class="bg-gradient-to-r from-blue-50 to-blue-100 min-h-screen">
    ...
    <section id="home" class="flex flex-col md:flex-row justify-between items-center min-h-screen py-16 px-8 md:px-16">
    ...
    <section id="about" class="py-16 bg-gradient-to-r from-gray-50 to-gray-100">
        <div class="max-w-6xl mx-auto px-4">
            ...
            <p class="text-gray-500 mb-6">DataForesight is a cutting-edge time series analysis platform designed to help businesses unlock powerful insights from their data. Our platform uses advanced machine learning algorithms to break down data into trend, seasonality, and forecasts, providing users with a comprehensive understanding of their data.</p>
            <p class="text-gray-500 mb-6">Our mission is to empower businesses to make data-driven decisions with confidence. We believe that data should be accessible and actionable, and we're committed to providing the tools and expertise to make that a reality.</p>
        </div>
    </section>
        ...
        <div class="max-w-6xl mx-auto px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="text-center animate-fade-in">
                    ...
                    <p class="text-gray-500">Our platform uses advanced machine learning algorithms to break down data into trend, seasonality, and forecasts.</p>
                </div>
                <div class="text-center animate-fade-in">
                    <i class="fas fa-bolt text-blue-600 text-4xl mb-4"></i>
                    <h3 class="font-bold text-lg text-gray-800">Predictive Modeling</h3>
                    <p class="text-gray-500">Our platform provides predictive modeling capabilities to help businesses forecast future trends and make data-driven decisions.</p>
                </div>
                <div class="text-center animate-fade-in">
                    <i class="fas fa-shield-alt text-blue-600 text-4xl mb-4"></i>
                    <h3 class="font-bold text-lg text-gray-800">Data Visualization</h3>
                    <p class="text-gray-500">Our platform provides interactive data visualization tools to help businesses gain insights and make data-driven decisions.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="contact" class="py-16 bg-gradient-to-r from-gray-50 to-gray-100">
        <div class="max-w-6xl mx-auto px-4">
            ...
            <p class="text-gray-500 mb-6">Have a question or want to learn more about our platform? We'd love to hear from you.</p>
            <form>
                ...
                <button class="bg-blue-500 hover:bg-blue-600 text-white font-medium px-8 py-3 rounded-lg shadow-lg transition duration-300 ease-in-out mt-4">Send Message</button>
            </form>
        </div>
    </section>
