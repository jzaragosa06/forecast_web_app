                ...
                <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                    ...
                    <div class="flex items-center mb-4">
                        <label class="flex items-center">
                            <input type="checkbox" name="terms" id="terms" required class="w-4 h-4 text-sky-600 bg-gray-100 border-gray-300 rounded focus:ring-sky-500 focus:ring-2">
                            <span for="terms" class="ml-2 text-sm font-medium text-gray-900">I agree to the <a href="#" class="text-blue-500 underline" id="openModal">Terms and
                                    Conditions</a></span>
                        </label>
                    </div>
