                ...
                <div class="w-full p-4 md:p-6 lg:p-8 md:w-1/2">
                    ...
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        <div class="flex flex-col md:flex-row md:space-x-4">
                            ...
                            <div class="relative z-0 w-full md:w-1/2 mb-4 md:mb-5">
                                <input type="text" name="mi" id="mi" autocomplete="family-name"
                                    class="block py-2 px-0 w-full text-sm lg:text-base text-gray-900 bg-transparent border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-sky-600 peer"
                                    placeholder=" " value="{{ old('mi') }}" required />
                                <label for="mi"
                                    class="absolute text-sm text-gray-500 duration-300 transform -translate-y-6 scale-75 top-3 left-0 z-10 origin-[0] peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">
                                    {{ __('Middle Initial') }}
                                </label>
                        ...
                        <div class="relative z-0 w-full mb-4 md:mb-5">
                            ...
                            <div id="password-criteria" class="mt-2 text-sm pl-4">
                                <p class="criteria text-xs text-gray-400" id="length">**At least 9 characters</p>
                                <p class="criteria text-xs text-gray-400" id="lowercase">**At least 3 lowercase letters</p>
                                <p class="criteria text-xs text-gray-400" id="uppercase">**At least 3 uppercase letters</p>
                                <p class="criteria text-xs text-gray-400" id="numbers">**At least 2 numbers</p>
                                <p class="criteria text-xs text-gray-400" id="special">**At least 1 special character</p>
                            </div>
                            @error('password')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        ...
                        <script>
                            ...
                            passwordInput.addEventListener('input', () => {
                                ...
                                const hasLowercase = (value.match(/[a-z]/g) || []).length >= 3;
                                const hasUppercase = (value.match(/[A-Z]/g) || []).length >= 3;
                                const hasNumbers = (value.match(/[0-9]/g) || []).length >= 2;
                                const hasSpecial = (value.match(/[^a-zA-Z0-9]/g) || []).length >= 1;
                                ...
                                updateCriteria(criteria.numbers, hasNumbers);
