...
@section('content')
    <div class="flex items-center justify-center min-h-screen bg-blue-100">
        <div class="flex bg-white rounded-lg shadow-lg max-w-4xl w-full overflow-hidden">
            ...
            <div class="w-1/2 p-8">
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="flex items-center mb-4">
                        ...
                        <label for="remember"
                               class="ml-2 text-sm font-medium text-gray-900">{{ __('Remember Me') }}</label>
                    </div>
                    ...
                    @if (Route::has('password.request'))
                        <div class="text-center mt-4">
                            <a class="text-sm text-sky-500 hover:underline"
            ...
            <!-- Welcome Section -->
            <div class="w-1/2 bg-gradient-to-r from-cyan-500 to-blue-500 p-8 flex flex-col items-center justify-center text-white">
