...
@section('content')
    ...
    <div class="container mx-auto my-6">
        ...
        <!-- Modal for Flowchart -->
        <div id="flowchartModal" class="hidden fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center">
            <div class="bg-white p-5 rounded-lg shadow-lg">
                <button id="closeModal" class="text-red-500 float-right">✖</button>
                <h3 class="font-bold mb-4">Flowchart</h3>
                <div class="mermaid">
                    graph TD;
