        ...
        <div class="modal-body">
            <form action="{{ route('upload.ts') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    ...
                    <select name="type" class="form-select block w-full border-gray-300 rounded-md shadow-sm" required>
                ...
                <div class="mb-4">
                    ...
                    <select name="freq" class="form-select block w-full border-gray-300 rounded-md shadow-sm" required>
            ...
            <form action="{{ route('manage.operations') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <div class="flex items-center mt-1">
                        <input type="radio" name="method" value="without_refit" id="without_refit" class="mr-2">
...
<div class="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-50 hidden"
    ...
    <div class="bg-white p-4 rounded-lg shadow-md w-full md:w-2/3 xl:w-1/3 max-h-screen overflow-y-auto">
        <div class="flex justify-between items-center border-b pb-2 mb-2">
            ...
            <form action="" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    <div>
                        ...
                        <div class="flex items-center mb-2">
                            <input class="form-checkbox" type="checkbox" id="temperature_2m_max_daily" name="daily"
                                value="temperature_2m_max">
                            <label class="ml-2" for="temperature_2m_max_daily">Maximum Temperature (2 m)</label>
                        </div>
                        <div class="flex items-center mb-2">
                            <input class="form-checkbox" type="checkbox" id="temperature_2m_min_daily" name="daily"
                                value="temperature_2m_min">
                            <label class="ml-2" for="temperature_2m_min_daily">Minimum Temperature (2 m)</label>
                        </div>
                        <div class="flex items-center mb-2">
                            <input class="form-checkbox" type="checkbox" id="temperature_2m_mean_daily" name="daily"
                        ...
                        <div class="flex items-center mb-2">
                            <input class="form-checkbox" type="checkbox" id="sunset_daily" name="daily" value="sunset">
                    ...
                    <div>
                        ...
                        <div class="flex items-center mb-2">
                            <input class="form-checkbox" type="checkbox" id="precipitation_hours_daily" name="daily"
                                value="precipitation_hours">
                            <label class="ml-2" for="precipitation_hours_daily">Precipitation Hours</label>
                        </div>
                        <div class="flex items-center mb-2">
                            <input class="form-checkbox" type="checkbox" id="wind_speed_10m_max_daily" name="daily"
                                value="wind_speed_10m_max">
                            <label class="ml-2" for="wind_speed_10m_max_daily">Maximum Wind Speed (10 m)</label>
                        </div>
                        <div class="flex items-center mb-2">
                            <input class="form-checkbox" type="checkbox" id="wind_gusts_10m_max_daily" name="daily"
                        ...
                        <div class="flex items-center mb-2">
                            <input class="form-checkbox" type="checkbox" id="shortwave_radiation_sum_daily" name="daily"
