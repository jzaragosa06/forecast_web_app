            ...
            <div class="bg-gray-50 col-span-3 space-y-4 h-full w-full">
                                ...
                                <div class="border bg-white p-4 rounded-lg shadow-md h-full flex flex-col">
                                    ...
                                    <div class="space-y-4">
                                        ...
                                        <div class="flex flex-col sm:flex-row items-center space-x-0 sm:space-x-2">
                                            <p class="text-gray-600 text-xs flex-grow">Upload your time series data in
                                                <a href="{{ route('documentation') }}"
                                                    class="text-gray-600 hover:text-blue-500 underline">
                                                    csv format
                                                </a>.
                                            </p>
                                            <button type="button" id="ts-info"
                                                class="flex items-center bg-blue-600 text-white px-3 py-2 rounded-md hover:bg-blue-700 w-full sm:w-auto mt-2 sm:mt-0">
                                        ...
                                        <div class="flex flex-col sm:flex-row items-center space-x-0 sm:space-x-2">
                                            <p class="text-gray-600 text-xs flex-grow">Get daily time series weather
                                                data anywhere</p>
                                        ...
                                        <!-- Stocks Data Button -->
                                        <div class="flex flex-col sm:flex-row items-center space-x-0 sm:space-x-2">
                                            <p class="text-gray-600 text-xs flex-grow">Get latest basic time series
                                                stock market data</p>
                                    ...
                                    <form id="analyze-form1" action="{{ route('manage.operations') }}" method="post"
                                        ...
                                        <div class="mb-4 relative">
                                            ...
                                            <div class="flex items-center">
                                                <select name="file_id" id="file_id"
                                                    class="form-select text-sm border-2 border-gray-300 block w-full rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                                                    @foreach ($groupedFiles as $category => $files_group)
                                                        <optgroup label="{{ ucfirst($category) }}" class="text-gray-600">
                                        ...
                                        <div class="mb-4 relative">
                                            ...
                                            <div class="flex items-center">
                                                ...
                                                <i id="operation-info"
                                                    class="fas fa-sm fa-info-circle text-gray-400 ml-2 cursor-pointer"
                                                    data-tooltip="Select the operation you want to apply to the selected file."></i>
                                            </div>
                                        </div>
                ...
                <div>
                    <div>
                        ...
                        <div class="flex flex-wrap items-center space-x-2 p-4 justify-center md:space-x-4">
                            <!-- Uploaded Data Button -->
                            <button id="input-via-uploads-Btn"
                                class="bg-blue-600 text-white border border-blue-600 px-3 py-2 rounded-md text-sm mb-2 sm:w-full md:w-auto md:mb-0">
                                Uploaded Data
                            </button>
                            <!-- Weather Data Button -->
                            <button id="input-via-openmeteo-Btn"
                                class="bg-white text-blue-600 border border-blue-600 px-3 py-2 rounded-md text-sm mb-2 sm:w-full md:w-auto md:mb-0">
                                Weather Data
                            </button>
                            <!-- Stocks Data Button -->
                        ...
                        <div id="input-via-uploads-Container">
                            <div class="container mx-auto p-4">
                                ...
                                @if ($uploadsExist)
                                    ...
                                    @foreach ($timeSeriesData as $index => $fileData)
                                        @if ($files[$index]->source == 'uploads')
                                            <div class="bg-white border rounded-lg shadow-md mb-4 overflow-hidden">
                                                <div class="p-4">
                                                    <div class="flex flex-wrap">

                                                        <!-- Left Section (Title, Type, Frequency, etc.) -->
                                                        <div
                                                            class="w-full lg:w-1/3 bg-gray-100 p-4 rounded-lg flex flex-col mb-4 lg:mb-0">
                                                            <h4
                                                                class="text-base font-semibold mb-2 text-gray-700 hover:text-blue-600 truncate">
                                                                <a
                                                                    href="{{ route('input.file.graph.view.post', $files[$index]->file_id) }}">
                                                                    {{ $files[$index]->filename }}
                                                                </a>
                                                            </h4>
                                                            <p class="text-xs mb-1">Type: {{ $files[$index]->type }}</p>
                                                            <p class="text-xs mb-1">Frequency: {{ $files[$index]->freq }}</p>
                                                            <p class="text-xs mb-1">Uploaded:
                                                                {{ $files[$index]->created_at->diffForHumans() }}
                                                            </p>

                                                            <!-- Description section -->
                                                            <div class="bg-gray-200 flex-grow p-4 rounded-lg break-words">
                                                                <p class="text-xs mb-1">{{ $files[$index]->description }}</p>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="graph-container mt-4 w-full"
                                                                style="height: 250px; max-height: 400px; overflow-hidden;">
                                                                <div id="graph-{{ $index }}" class="w-full h-full"
                        ...
                        <div id="input-via-openmeteo-Container" class="hidden">
                            <div class="container mx-auto p-4">
                                @php
                                    // Filter the timeSeriesData to check for 'open-meteo' source
                                    $uploadsExist = false;
                                    foreach ($files as $index => $fileData) {
                                ...
                                @if ($uploadsExist)
                                    <!-- Loop through timeSeriesData if there is data from 'open-meteo' -->
                                    @foreach ($timeSeriesData as $index => $fileData)
                                        @if ($files[$index]->source == 'open-meteo')
                                            <div class="bg-white border rounded-lg shadow-md mb-4 overflow-visible">
                                                <div class="p-4">
                                                    <div class="flex flex-wrap">
                                                        ...
                                                        <div
                                                            ...
                                                            <!-- Graph Container -->
                                                            <div class="graph-container mt-4 w-full sm:h-48 md:h-60 lg:h-80"
                                    ...
                                    @endforeach
                                @else
                                    <!-- Display if no 'open-meteo' data is found -->
                                    <div class="bg-white border rounded-lg shadow-md mb-4 p-4 text-center">
                                        <p class="text-lg font-semibold text-gray-600">No data exists</p>
                                    </div>
                                @endif
                        ...
                        <div id="input-via-stocks-Container" class="hidden">
                            <div class="container mx-auto p-4">
                                @php
                                    // Filter the timeSeriesData to check for 'stocks' source
                                    $uploadsExist = false;
                                    foreach ($files as $index => $fileData) {
                                ...
                                @if ($uploadsExist)
                                    <!-- Loop through timeSeriesData if there is data from 'stocks' -->
                                    @foreach ($timeSeriesData as $index => $fileData)
                                        @if ($files[$index]->source == 'stocks')
                                    ...
                                    @endforeach
                                @else
                                    <!-- Display if no 'stocks' data is found -->
                                    <div class="bg-white border rounded-lg shadow-md mb-4 p-4 text-center">
                                        <p class="text-lg font-semibold text-gray-600">No data exists</p>
                                    </div>
                                @endif
                        ...
                        <div id="input-via-public-Container" class="hidden">
                            <div class="container mx-auto p-4">
                                @php
                                    // Filter the timeSeriesData to check for 'public' source
                                    $uploadsExist = false;
                                    foreach ($files as $index => $fileData) {
                                ...
                                @if ($uploadsExist)
                                    <!-- Loop through timeSeriesData if there is data from 'public' -->
                                    @foreach ($timeSeriesData as $index => $fileData)
                                        @if ($files[$index]->source == 'public')
                                            <div class="bg-white border rounded-lg shadow-md mb-4">
                                                <div class="p-4">
                                    ...
                                    @endforeach
                                @else
                                    <!-- Display if no 'public' data is found -->
                                    <div class="bg-white border rounded-lg shadow-md mb-4 p-4 text-center">
                                        <p class="text-lg font-semibold text-gray-600">No data exists</p>
                                    </div>
                                @endif
                            ...
                            <div
                                ...
                                <div class="p-4">
                                    ...
                                    <h5 class="text-base font-semibold text-gray-700 mb-1">
                                        <a href="{{ route('posts.show', $post) }}" class="hover:text-blue-600 line-clamp-1">
                                            {{ $post->title }}
                                        </a>
                                    </h5>
...
<div class="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-50 hidden" id="ts-info-form"
    style="display:none;">
    <div class="bg-white p-4 rounded-lg shadow-md w-full sm:w-11/12 md:w-1/2 lg:w-1/3 xl:w-1/4">
        <div class="flex justify-between items-center border-b pb-2 mb-2">
            <h5 class="text-lg sm:text-base font-semibold">Information About the Time Series Data</h5>
            <button type="button" class="text-gray-600 hover:text-gray-800" data-dismiss="modal" aria-label="Close">
                &times;
            </button>
        </div>
            ...
            <form action="{{ route('upload.ts') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    ...
                    <input type="file" name="file" id="file"
                        class="form-input block w-full border-gray-300 rounded-md shadow-sm" accept=".csv, .xls, .xlsx">
                </div>
                ...
                <div class="mb-4">
                    ...
                    <div class="flex items-center">
                        ...
                        <!-- Icon and Tooltip Wrapper -->
                        <div class="relative inline-block ml-2 group">
                            <i id="description-info" class="fas fa-sm fa-info-circle text-gray-400 cursor-pointer"></i>
...
<div class="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-50 hidden"
    ...
    <div
        class="bg-white p-4 rounded-lg shadow-md w-full sm:w-11/12 md:w-2/3 lg:w-1/2 xl:w-1/3 max-h-[90vh] overflow-y-auto">

        <div class="flex justify-between items-center border-b pb-2 mb-2">
            <h5 class="text-lg sm:text-base font-semibold">Open Meteo</h5>
            <button type="button" class="text-gray-600 hover:text-gray-800" data-dismiss="modal" aria-label="Close">
                &times;
            </button>
        </div>
        <p class="text-xs text-gray-500 mb-4">
            ...
            specified start and end date range. A maximum of 5 weather variables is supported.
        </p>
            ...
            <form action="" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <button type="button" id="use-current-loc-btn"
                        class="bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700 transition-all w-full sm:w-auto">
                ...
                <!-- Submit Button (no longer fixed) -->
                <div class="mb-4">
                    <button id="fetch-data-open-meteo-btn" type="submit"
                        class="bg-blue-600 text-white px-6 py-3 rounded-md hover:bg-blue-700 w-full sm:w-auto">
                        Fetch
                    </button>
                </div>
            </form>
...
<div id="ts-add-via-api-stocks-modal"
    ...
    <div
        class="bg-white p-6 rounded-lg shadow-lg w-full sm:max-w-md md:max-w-lg lg:max-w-xl max-h-[90vh] overflow-y-auto">
        ...
        <ul class="text-xs text-gray-500 list-disc ml-6 mb-4">
        ...
        <p class="text-xs text-gray-500 mb-4">
            Refer to this article to know more about <a class="underline text-blue-600"
                href="https://www.investopedia.com/terms/c/commonstock.asp">common stocks</a>. Data can be extracted
        ...
        <div class="modal-body">
            ...
            <div class="flex justify-end mt-6 space-x-4">
                ...
                <button id="fetch-data-stocks" type="submit"
                    class="bg-blue-600 text-white px-6 py-3 rounded-md hover:bg-blue-700">Fetch</button>
            </div>
        </div>
    </div>
</div>
