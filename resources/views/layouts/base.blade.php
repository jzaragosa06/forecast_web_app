...
<head>
    ...
    <!-- Google Maps -->
    <script
        src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBHELiMiSckEBBGpn5KaM9TZVlYGevcKTg&libraries=places"></script>
    <!-- Apexchart CDN -->
...
<body class="bg-gray-100">
    ...
    <div class="flex">
        ...
        <div class="ml-20 flex-1 overflow-y-auto h-screen flex flex-col">
