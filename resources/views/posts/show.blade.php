...
@section('content')
    ...
    @if ($file_meta['operation'] == 'forecast')
        @if ($file_meta['inputFileType'] == 'univariate')
            <!-- Chart Container for the forecast -->
            <div id="chart1"></div>
    ...
    @elseif ($file_meta['operation'] == 'trend')
        @if ($file_meta['inputFileType'] == 'univariate')
            <!-- Chart Container for trend-->
            <div id="chart1"></div>
            <!-- Chart Container for Input data -->
            <div id="chart"></div>
        @else
            <!-- Chart Container for trend result -->
    ...
    @else
        ...
        @else
            ...
            <!-- Chart Container for seasonality result -->
            <div id="chart-container" class="flex flex-col gap-6">
                <!-- Dynamic charts will be inserted here -->
            </div>
            <!-- Chart Container for Input data -->
...
@section('content')
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 px-6 py-4">
        ...
        <!-- Right Column: Graphs and Buttons -->
        <div class="bg-gray-100 p-4 rounded-lg shadow-md">
